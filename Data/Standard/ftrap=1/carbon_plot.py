...
DATA_SETS = {
    ...
    "ATM C": ("Carbon in Atmosphere", "atmosphere.pdf", "atmosphere.ps", 3),
    "OC C": ("Carbon in Ocean", "ocean.pdf", "ocean.ps", 4),
    "P C": ("Carbon in Ocean Crust", "plate.pdf", "plate.ps", 5),
    "Total C": ("Carbon in Whole mantle", "whole_mantle.pdf", "whole_mantle.ps", -4),
    ...
    "Subd": ("Subduction Flux", "subd.pdf", "subd.ps", -3),
    "Total": ("Total Volcanic Outgassing", "total.pdf", "total.ps", -2),
    "Melt": ("Trapped Melt to Lower Mantle", "trapped_melt.pdf", "trapped_melt.ps", -1)
}
